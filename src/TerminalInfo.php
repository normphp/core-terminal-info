...
use normphpCore\terminalInfo\ToLocation;
class TerminalInfo{
    /**
...
//        }
    ...
    {
        $ToLocation = new ToLocation($update,dirname($_SERVER['SCRIPT_FILENAME'],self::$levels).DIRECTORY_SEPARATOR."qqwry.dat",'normphp');
